...
export default function ProjectHealthCircle({ score = 87, openH ,reFresh,visibleRefresh = false,mode,}: { mode:String,score: number, openH: () => void , reFresh: () => void ,visibleRefresh:boolean}) {
