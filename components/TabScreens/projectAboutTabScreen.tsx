...
const ProjectAboutTabScreen = ({about,openEditAbout,repo,owner,stopNavigation,}:ProjectProviderProps) => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{backgroundColor: "#1e1e22", borderRadius: 12, marginBottom: 12, padding: 12, justifyContent:"center", alignItems:"center"}}>
                <View style={{
                    padding:16,
                    borderWidth:1,
                    borderColor: "#282a2a",
                ...
                <Text style={{
                    ...
                    marginVertical:7,
                    marginHorizontal:25,
                }}>Make your project stand out by adding a detailed description. You can fetch it from your GitHub README or generate one using AI.</Text>
